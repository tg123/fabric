...
func (v *comFabricClientSettings) SetKeepAlive(
	...
	hr, err1 := callStub15718182357955102547(
...
func (v *comFabricPropertyManagementClient) beginEnumerateSubNames(
	...
	hr, err1 := callStub5955222752708360228(
		v.vtable().BeginEnumerateSubNames,
		6,
		unsafe.Pointer(v),
		unsafe.Pointer(p_0),
		unsafe.Pointer(previousResult),
		recursive,
		timeoutMilliseconds,
		unsafe.Pointer(callback),
		unsafe.Pointer(&p_5),
...
func (v *comFabricPropertyManagementClient) beginPutPropertyBinary(
	...
	hr, err1 := callStub10058214422621334751(
...
func (v *comFabricPropertyManagementClient) beginPutPropertyInt64(
	...
	hr, err1 := callStub1630288334828793287(
...
func (v *comFabricPropertyManagementClient) beginPutPropertyDouble(
	...
	hr, err1 := callStub12664629900598883453(
...
func (v *comFabricPropertyManagementClient) beginPutPropertyWString(
	...
	hr, err1 := callStub9660077576991986601(
...
func (v *comFabricPropertyManagementClient) beginSubmitPropertyBatch(
	...
	hr, err1 := callStub9429292076469177682(
...
func (v *comFabricPropertyManagementClient) beginEnumerateProperties(
	...
	hr, err1 := callStub17320848538307195614(
...
func (v *comFabricServiceManagementClient) beginCreateServiceFromTemplate(
	...
	hr, err1 := callStub14727739111527231414(
...
func (v *comFabricServiceManagementClient) RegisterServicePartitionResolutionChangeHandler(
	...
	hr, err1 := callStub7503403356184589199(
...
func (v *comFabricServiceManagementClient) beginResolveServicePartition(
	...
	hr, err1 := callStub15487510995445485658(
...
func (v *comFabricServiceManagementClient4) beginUnregisterServiceNotificationFilter(
	...
	hr, err1 := callStub7287933853701551490(
...
func (v *comFabricApplicationManagementClient4) beginDeployServicePackageToNode(
	...
	hr, err1 := callStub17244673165462293359(
...
func (v *comFabricClusterManagementClient2) beginDeactivateNode(
	...
	hr, err1 := callStub17177410701984374373(
...
func (v *comFabricClusterManagementClient3) CopyClusterPackage(
	...
	hr, err1 := callStub4555919410121256920(
...
func (v *comFabricClusterManagementClient6) beginToggleVerboseServicePlacementHealthReporting(
	...
	hr, err1 := callStub15846046096096524420(
...
func (v *comFabricHealthClient) beginGetReplicaHealth(
	...
	hr, err1 := callStub13310073979949236625(
...
func (v *comFabricHealthClient) beginGetDeployedServicePackageHealth(
	...
	hr, err1 := callStub10107670971298011941(
...
func (v *comFabricUpgradeProgressResult) GetChangedUpgradeDomains(
	...
	hr, err1 := callStub8271036529602806980(
		...
		3,
		unsafe.Pointer(v),
		unsafe.Pointer(previousProgress),
		unsafe.Pointer(&p_1),
		unsafe.Pointer(&p_2),
	)
	if hr != 0 {
...
func (v *comFabricServicePartitionResolutionChangeHandler) OnChange(
	...
	hr, err1 := callStub5789215629241811153(
		v.vtable().OnChange,
		4,
		unsafe.Pointer(v),
...
func newComFabricServiceNotificationEventHandler(
	...
	*(**comFabricServiceNotificationEventHandlerVtbl)(unsafe.Pointer(com)) = &comFabricServiceNotificationEventHandlerVtbl{}
	...
	vtbl.OnNotification = createCallbackStub13508278033908553326(com.proxy.OnNotification)
...
func newComFabricClientConnectionEventHandler(
	...
	*(**comFabricClientConnectionEventHandlerVtbl)(unsafe.Pointer(com)) = &comFabricClientConnectionEventHandlerVtbl{}
	...
	vtbl.OnConnected = createCallbackStub13508278033908553326(com.proxy.OnConnected)
	vtbl.OnDisconnected = createCallbackStub13508278033908553326(com.proxy.OnDisconnected)
...
func (v *comFabricSecretStoreClient) beginGetSecrets(
	...
	hr, err1 := callStub15598723421636958591(
