...
func (v *comFabricPropertyManagementClient) beginPutPropertyBinary(
	...
	p_0 = utf16PtrFromString(name)
	var p_1 *uint16
	p_1 = utf16PtrFromString(propertyName)
	var p_6 *comFabricAsyncOperationContext
	defer func() {
		context = p_6
	}()
	hr, err1 := callStub4178191533(
...
func (v *comFabricPropertyManagementClient) beginPutPropertyWString(
	...
	p_1 = utf16PtrFromString(propertyName)
	var p_2 *uint16
	p_2 = utf16PtrFromString(data)
	var p_5 *comFabricAsyncOperationContext
	defer func() {
		context = p_5
	}()
	hr, err1 := callStub1174610639(
...
func (v *comFabricServiceManagementClient) beginCreateServiceFromTemplate(
	...
	var p_0 *uint16
	p_0 = utf16PtrFromString(applicationName)
	var p_1 *uint16
	p_1 = utf16PtrFromString(serviceName)
	var p_2 *uint16
	p_2 = utf16PtrFromString(serviceTypeName)
	var p_7 *comFabricAsyncOperationContext
	defer func() {
		context = p_7
	}()
	hr, err1 := callStub10168106(
...
func (v *comFabricServiceManagementClient2) beginGetServiceManifest(
	...
	var p_0 *uint16
	p_0 = utf16PtrFromString(applicationTypeName)
	var p_1 *uint16
	p_1 = utf16PtrFromString(applicationTypeVersion)
	var p_2 *uint16
	p_2 = utf16PtrFromString(serviceManifestName)
	var p_5 *comFabricAsyncOperationContext
	defer func() {
		context = p_5
	}()
...
func (v *comFabricApplicationManagementClient) beginProvisionApplicationType(
	...
	var p_0 *uint16
	p_0 = utf16PtrFromString(applicationBuildPath)
	var p_3 *comFabricAsyncOperationContext
	defer func() {
		context = p_3
	}()
...
func (v *comFabricApplicationManagementClient2) beginMoveNextApplicationUpgradeDomain2(
	...
	p_0 = utf16PtrFromString(applicationName)
	var p_1 *uint16
	p_1 = utf16PtrFromString(nextUpgradeDomain)
	var p_4 *comFabricAsyncOperationContext
	defer func() {
		context = p_4
	}()
...
func (v *comFabricApplicationManagementClient3) CopyApplicationPackage(
	...
	var p_0 *uint16
	p_0 = utf16PtrFromString(imageStoreConnectionString)
	var p_1 *uint16
	p_1 = utf16PtrFromString(applicationPackagePath)
	var p_2 *uint16
	p_2 = utf16PtrFromString(applicationPackagePathInImageStore)
	hr, err1 := callStub1487275852(
...
func (v *comFabricApplicationManagementClient3) RemoveApplicationPackage(
	...
	p_0 = utf16PtrFromString(imageStoreConnectionString)
	var p_1 *uint16
	p_1 = utf16PtrFromString(applicationPackagePathInImageStore)
	hr, err1 := callStub657523919(
...
func (v *comFabricApplicationManagementClient4) beginDeployServicePackageToNode(
	...
	lst_1 := &innerFabricPackageSharingPolicyList{}
	{
	...
	p_3 = lst_1
	var p_4 *uint16
	p_4 = utf16PtrFromString(nodeName)
	var p_7 *comFabricAsyncOperationContext
	defer func() {
		context = p_7
	}()
	hr, err1 := callStub3577164681(
...
func (v *comFabricClusterManagementClient) beginNodeStateRemoved(
	...
	var p_0 *uint16
	p_0 = utf16PtrFromString(nodeName)
	var p_3 *comFabricAsyncOperationContext
	defer func() {
		context = p_3
	}()
...
func (v *comFabricClusterManagementClient2) beginProvisionFabric(
	...
	var p_0 *uint16
	p_0 = utf16PtrFromString(codeFilepath)
	var p_1 *uint16
	p_1 = utf16PtrFromString(clusterManifestFilepath)
	var p_4 *comFabricAsyncOperationContext
	defer func() {
		context = p_4
	}()
...
func (v *comFabricClusterManagementClient2) beginMoveNextFabricUpgradeDomain2(
	...
	var p_0 *uint16
	p_0 = utf16PtrFromString(nextUpgradeDomain)
	var p_3 *comFabricAsyncOperationContext
	defer func() {
		context = p_3
	}()
...
func (v *comFabricClusterManagementClient2) beginUnprovisionFabric(
	...
	var p_0 *uint16
	p_0 = utf16PtrFromString(codeVersion)
	var p_1 *uint16
	p_1 = utf16PtrFromString(configVersion)
	var p_4 *comFabricAsyncOperationContext
	defer func() {
		context = p_4
	}()
...
func (v *comFabricClusterManagementClient2) beginRecoverServicePartitions(
	...
	var p_0 *uint16
	p_0 = utf16PtrFromString(serviceName)
	var p_3 *comFabricAsyncOperationContext
	defer func() {
		context = p_3
	}()
...
func (v *comFabricClusterManagementClient3) CopyClusterPackage(
	...
	p_0 = utf16PtrFromString(imageStoreConnectionString)
	var p_1 *uint16
	p_1 = utf16PtrFromString(clusterManifestPath)
	var p_2 *uint16
	p_2 = utf16PtrFromString(clusterManifestPathInImageStore)
	var p_3 *uint16
	p_3 = utf16PtrFromString(codePackagePath)
	var p_4 *uint16
	p_4 = utf16PtrFromString(codePackagePathInImageStore)
	hr, err1 := callStub4148694086(
...
func (v *comFabricClusterManagementClient3) RemoveClusterPackage(
	...
	p_0 = utf16PtrFromString(imageStoreConnectionString)
	var p_1 *uint16
	p_1 = utf16PtrFromString(clusterManifestPathInImageStore)
	var p_2 *uint16
	p_2 = utf16PtrFromString(codePackagePathInImageStore)
	hr, err1 := callStub1487275852(
...
func (v *comFabricClusterManagementClient10) beginGetClusterConfiguration2(
	...
	var p_0 *uint16
	p_0 = utf16PtrFromString(apiVersion)
	var p_3 *comFabricAsyncOperationContext
	defer func() {
		context = p_3
	}()
...
func (v *comFabricHealthClient) beginGetDeployedApplicationHealth(
	...
	p_0 = utf16PtrFromString(applicationName)
	var p_1 *uint16
	p_1 = utf16PtrFromString(nodeName)
	var p_2 *innerFabricApplicationHealthPolicy
	p_2 = healthPolicy.toInnerStruct()
	var p_5 *comFabricAsyncOperationContext
	defer func() {
...
func (v *comFabricHealthClient) beginGetDeployedServicePackageHealth(
	...
	p_0 = utf16PtrFromString(applicationName)
	var p_1 *uint16
	p_1 = utf16PtrFromString(serviceManifestName)
	var p_2 *uint16
	p_2 = utf16PtrFromString(nodeName)
...
func (v *comFabricInfrastructureServiceClient) beginInvokeInfrastructureCommand(
	...
	p_0 = utf16PtrFromString(serviceName)
	var p_1 *uint16
	p_1 = utf16PtrFromString(command)
	var p_4 *comFabricAsyncOperationContext
	defer func() {
		context = p_4
	}()
...
func (v *comFabricNetworkManagementClient) beginCreateNetwork(
	...
	var p_0 *uint16
	p_0 = utf16PtrFromString(networkName)
...
func (v *comFabricPropertyValueResult) GetValueAsWString() (bufferedValue string, err error) {
	var p_0 *uint16
	defer func() {
		bufferedValue = utf16PtrToString(p_0)
	}()
	hr, err1 := callStub183829116(
...
func newComFabricServiceNotificationEventHandler(
	...
	*(**comFabricServiceNotificationEventHandlerVtbl)(unsafe.Pointer(com)) = &comFabricServiceNotificationEventHandlerVtbl{}
	...
	vtbl.OnNotification = createCallbackStub2776959849(com.proxy.OnNotification)
...
func newComFabricClientConnectionEventHandler(
	...
	*(**comFabricClientConnectionEventHandlerVtbl)(unsafe.Pointer(com)) = &comFabricClientConnectionEventHandlerVtbl{}
	...
	vtbl.OnConnected = createCallbackStub3830844808(com.proxy.OnConnected)
	vtbl.OnDisconnected = createCallbackStub3830844808(com.proxy.OnDisconnected)
...
func (v *comFabricTestCommandStatusResult) GetResult() (rt []TestCommandQueryResultItem, err error) {
	hr, err1 := callStub1(
		v.vtable().get_Result,
		0,
		unsafe.Pointer(v),
...

	{
		...
		for _, item := range innerlst {
			var tmpitem TestCommandQueryResultItem
...
func (v *comFabricSecretStoreClient) beginGetSecrets(
	...
	lst_2 := &innerFabricSecretReferenceList{}
	{
...
func (v *comFabricSecretStoreClient) beginRemoveSecrets(
	...
	var p_0 *innerFabricSecretReferenceList
	lst_4 := &innerFabricSecretReferenceList{}
	{
...
func (v *comFabricSecretStoreClient) beginGetSecretVersions(
	...
	var p_0 *innerFabricSecretReferenceList
	lst_5 := &innerFabricSecretReferenceList{}
	{
