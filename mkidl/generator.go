...
func (g *generator) headerprintf(format string, args ...interface{}) {
	fmt.Fprintf(&g.header, format, args...)
}

func (g *generator) headerprintfln(format string, args ...interface{}) {
	g.headerprintf(format, args...)
